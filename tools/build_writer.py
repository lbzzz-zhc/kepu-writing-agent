...
async function callModel(messages, temperature){
  ...
  const url = (c.useProxy ? '/api/chat' : c.base.replace(/\/+$/,'') + '/chat/completions');
...
<div class="wrap">
  ...
  <div class="card">
    ...
    <textarea id="material" placeholder="把标准原文、官方通报、权威报道原文粘进来。资料越实，成稿越稳。"></textarea>
    <div class="row">
